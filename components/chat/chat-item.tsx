...
export const ChatItem = ({
   ...
   const isLoading = form.formState.isSubmitting;
    ...
    return <div className="relative group flex   items-center
    hover:bg-black/5 p-4 transition w-full">
                                    ...
                                    <FormItem className="flex-1">
                                        <FormControl>
                                            <div className="relative w-full">
                                                <Input 
                                                 disabled={isLoading}
                                                className="dark:bg-zinc-700/75 border-none
                                                    p-2 bg-zinc-200/90 
        ...
        {canDeleteMessage && (
            ...
            absolute p-2 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm"
            >
