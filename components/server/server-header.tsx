...
import { DropdownMenuContent, DropdownMenuItem, DropdownMenu, DropdownMenuTrigger, DropdownMenuSeparator } from "@/components/ui/dropdown-menu";
...
export const ServerHeader = ({
    ...
    return (
        <DropdownMenu>
         ...
         dark:hover:bg-zinc-700/50 transation">
                    {server.name}
